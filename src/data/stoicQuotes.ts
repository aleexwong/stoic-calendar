...
export const footerMessages = [
  ...
  "Amor fati.",
  "This too shall pass.",
  "Breathe. Observe. Choose well.",
  "Train the mind. Free the soul.",
  "No borrowed tomorrow.",
  "Steady hands, quiet heart.",
  "Do the next right thing.",
  "Let reason hold the reins.",
  "Fortune tests; character answers.",
  "Be strict with yourself, gentle with others.",
  "Welcome what comes. Use it well.",
  "Small disciplines, strong days.",
  "Own your response.",
  "Meet fate with open eyes.",
  "Less complaint, more courage.",
  "Today is enough to practice virtue.",
  "Waste no dawn.",
];
